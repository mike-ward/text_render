...
If build fails, check for compile errors from Plan 01/02 changes.
  ...
  <verify>
`v examples/editor_demo.v` compiles without errors and editor_demo window appears
  </verify>
  <done>
editor_demo built and running, ready for IME testing
  </done>
</task>
...
- Note which monitor configurations were tested
  ...
  <verify>
`grep -c "Phase: 21" .planning/STATE.md` returns 1 AND "Current Position" section reflects
checkpoint results
  </verify>
  <done>
STATE.md updated with Phase 21 status, test results documented, known issues updated based on
